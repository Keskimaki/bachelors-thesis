...
CI tarkoittaa koodimuutosten vientiä versionhallintaan nopealla tahdilla ja muutosten automaattista testausta koodimuutosten jälkeen.
...
Kuva \ref{fig:cicd} esittää esimerkin mahdollisesta CI/CD-putkesta. CI/CD käynnistyy kehittäjän viedessä uuden koodimuutoksen versiohallintaan.
...
% Tässä tutkielmassa keskitytään DevOps-toimintamallin teknisiin haasteisiin.
% CI/CD-putken toteutus ja 
...
% Propbably need to rethink this section somewhat, check the email
